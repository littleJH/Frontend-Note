...
type MyAwaited<T> = T extends Promise<infer R> ? MyAwaited<R> :  T extends Thenable<infer U> ? U : T

// 或者 type MyAwaited<T> = T extends Thenable<infer U> ? MyAwaited<U> : T 也是可以的
